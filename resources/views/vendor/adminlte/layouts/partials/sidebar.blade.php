...
<aside class="main-sidebar" style="background-color: {{$array_color['menu_color']}};">
    ...
    <section class="sidebar">
        ...
        <ul class="sidebar-menu" data-widget="tree">
            ...
            <li class="treeview">
                <a href="#"><i class='fa fa-link'></i> <span>Pabellòn</span> <i class="fa fa-angle-left pull-right"></i></a>
                ...
                <li><a href="{{ url('/dashboard8') }}"><i class='fa fa-link'></i> <span>Espiga</span></a></li>
                <li><a href="{{ url('/dashboard9') }}"><i class='fa fa-link'></i> <span>Catire Paez</span></a></li>
                </ul>
            </li>
            <li class="treeview">
